...
--
-- Host: localhost:3306
-- Generation Time: Aug 22, 2025 at 02:08 AM
...
(1, 'AdminHans', '21232f297a57a5a743894a0e4a801fc3'),
(2, 'CoAdmin', 'f400e5f5671721f00184c353bd356720'),
(3, 'CoAdmin', '9673a5085810ad1dd3274abd75c03cea');
...
CREATE TABLE `tbkendaraan` (
  ...
  `seri` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tbsyaratsewa` (
  `id` int NOT NULL,
  `persyaratan` text COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
