...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update data admin
    $sql = "UPDATE tbadmin SET nama='$nama', password='$password' WHERE id='$id'";

    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Admin berhasil diperbarui!'); window.location.href='admininfo.php';</script>";
    } else {
...
<head>
    ...
    <title>Edit Admin - Hans Rental</title>
...
<body>
    ...
    <div class="container">
        <form action="" method="POST">
            ...
            <button type="submit"><i class="fas fa-edit"></i> Update Admin</button>
